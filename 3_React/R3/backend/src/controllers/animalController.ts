...
//esta función maneja la solicitud para listar animales,
...
//esta función maneja la solicitud para crear un nuevo animal,
...
//esta función maneja la solicitud para actualizar un animal existente,
//recibiendo el id del animal en los parámetros de la solicitud y
...
//esta función maneja la solicitud para eliminar un animal,
//recibiendo el id del animal en los parámetros de la solicitud y
...
//el traslado a enfermería se realiza mediante la actualización del estado de salud
//del animal a "enfermo" y la asignación de un corral de enfermería.

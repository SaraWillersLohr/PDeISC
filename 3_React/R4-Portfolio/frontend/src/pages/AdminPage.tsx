...
//estableco las secciones editables
const sections = [
  ["projects", "proyectos"],
...
export function AdminPage() {
  ...
  //detecto primer login y cambia contraseña
  ...
  //cargo los datos de la sección seleccionada
  const load = async () => {
    if (!token) return;
    try {
  ...
  //efecto para cargar los datos cuando cambia la sección o el token
  useEffect(() => {
    load();
  }, [section, token]);
  ...
  //función para cambiar la contraseña en el primer login
